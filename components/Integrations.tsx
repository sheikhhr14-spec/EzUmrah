    ...
    <section id="integrations" className="section relative" style={{ background: 'var(--midnight2)' }}>
      <div className="container relative z-10">
        <div className="text-center mb-16">
          <span className="section-eyebrow">{t('integrations.eyebrow')}</span>
          <h2 className="section-title">{t('integrations.title')}</h2>
          ...
          {integrations.map((integ, i) => (
            <div key={i} className="glass-card p-8 text-center fade-up" style={{ animationDelay: `${i * 0.1}s` }}>
              ...
              <span
                ...
                style={{ background: 'rgba(13,148,136,0.1)', color: 'var(--teal-light)', border: '1px solid rgba(13,148,136,0.2)' }}
              >
                ✓ Available
              </span>
            </div>
