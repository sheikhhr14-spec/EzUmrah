    ...
    <div className="max-w-2xl mx-auto">
      <div className="glass-card p-8 mb-6">
        ...
        <p className="text-sm mb-6" style={{ color: 'var(--text-dim)' }}>
          We serve agencies of all sizes — from startups to large operators handling thousands of pilgrims. Tell us about your agency, your current workflow, and what you&apos;re looking for.
        </p>
      ...
      <form onSubmit={handleSubmit} className="glass-card p-8 space-y-5">
        <div>
          ...
          <input type="text" name="name" required placeholder="Your full name"
            ...
            style={{ background: 'rgba(7, 8, 13, 0.6)', border: '1px solid var(--border)', color: 'var(--text)' }}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <textarea name="message" required rows={6} placeholder="Tell us about your agency and what you're looking for..."
