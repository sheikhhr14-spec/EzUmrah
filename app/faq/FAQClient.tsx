...
const faqs = [
  ...
  { q: 'Which countries does EzUmrah support?', a: 'EzUmrah is a globally available cloud platform used by travel agencies worldwide, including the UK, USA, Saudi Arabia, India, Pakistan, Turkey, Malaysia, Indonesia, Egypt, and the UAE. It supports multi-currency invoicing and is accessible worldwide.' },
