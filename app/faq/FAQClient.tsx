...
const faqs = [
  ...
  { q: 'Do you offer training and support?', a: 'Yes. Starter plans get email support, Agency Pro gets priority support, and Enterprise gets a dedicated account manager with 24/7 priority support. We also provide a full onboarding guide, help centre with articles, and live walkthroughs for larger teams.' },
