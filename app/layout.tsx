...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'GDS API', 'travel website development', 'Umrah travel portal', 'Hajj travel portal', 'Islamic travel software',
    ...
    'Saudi eVisa integration', 'Nusuk integration', 'Mecca hotel booking', 'Medina hotel booking',
    'Haram hotel CRM', 'Umrah travel agency software', 'Hajj travel agency software', 'Islamic travel CRM',
    ...
    'Umrah document vault', 'Hajj document management', 'travel invoice software', 'travel CRM Saudi Arabia',
    'Umrah software Saudi Arabia', 'Hajj software Saudi Arabia', 'travel CRM Middle East',
  ],
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.svg', width: 1200, height: 630, alt: 'EzUmrah — Cloud Travel CRM for Umrah & Hajj Agencies' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'EzUmrah — Cloud Travel CRM for Umrah & Hajj Agencies',
    description: 'The all-in-one cloud CRM for travel agencies managing Umrah, Hajj, and holiday packages.',
    images: ['/og-image.svg'],
  },
  robots: {
    index: true,
...
const jsonLd = [
  {
    ...
    operatingSystem: 'Web',
    url: SITE_URL,
    description: 'EzUmrah is a cloud-based CRM software specifically built for travel agencies that manage Umrah, Hajj, and holiday packages. It includes modules for group bookings, flight management, hotel reservations, visa tracking, transport, invoicing, quotations, document vault, and task management.',
    offers: [
